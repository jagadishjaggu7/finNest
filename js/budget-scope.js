    ...
    async function render() {
        ...
        const renderContent = async () => {
            ...
            try {
                ...
                host.querySelectorAll('[data-delete-id]').forEach(btn => btn.onclick = async () => { if (!confirm('Delete this budget?')) return; try { await removeBudget(btn.dataset.deleteId); await paint(); } catch (e) { alert(e.message || 'Unable to delete budget.'); } });
